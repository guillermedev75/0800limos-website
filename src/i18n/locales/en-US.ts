export default {
  ...
  areas: {
    ...
    locations: {
      ...
      monterey: { name: 'Monterey & Carmel', description: 'Two jewels of the California coast side by side. Monterey enchants with its marine wildlife and world-class aquarium, while Carmel-by-the-Sea captivates with its fairytale cottages, white-sand beach, and world-renowned golf courses at Pebble Beach.', highlights: ['17-Mile Drive', 'Pebble Beach Golf', 'Carmel-by-the-Sea'] },
