export default {
  ...
  destinations: {
    ...
    items: {
      ...
      vineyard: {
        name: 'Viñedos Napa Valley',
        location: 'País del Vino',
        description: 'Los viñedos más renombrados de California. Tours exclusivos y degustaciones privadas en las mejores bodegas de la región.',
      },
      winery: {
